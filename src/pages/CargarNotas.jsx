  ...
  return (
    <div className={`${isMobile ? 'p-4 pt-5' : 'ml-32 p-6'} min-h-screen`}>
      ...
      <button
        ...
        className="mb-3 md:mb-4 flex items-center gap-1 md:gap-2 bg-white hover:bg-gray-100 text-gray-700 font-medium py-2 px-4 rounded-lg border-2 border-white hover:border-white shadow-sm transition duration-200"
      >
